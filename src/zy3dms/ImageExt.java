...
public class ImageExt {
	...
	public static String GetImageExt(String filename) {
		...
		// }
		// 将字符串数组转化为double类型
		double xstr[] = { Double.parseDouble(data[0]), Double.parseDouble(data[2]), Double.parseDouble(data[4]),
				Double.parseDouble(data[6]) };
		double ystr[] = { Double.parseDouble(data[1]), Double.parseDouble(data[3]), Double.parseDouble(data[5]),
