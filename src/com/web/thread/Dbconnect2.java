...
public class Dbconnect2 {
	 ...
	 */
	public static String ToReadDb(String LayerName, String WhereClause) throws ParseException {
		...
		try {
			JDBCDataStore ds2 = (JDBCDataStore) factory2.createDataStore(params1);
			...
			strLayerJSON2 = strLayerJSON2.substring(strLayerJSON2.indexOf("[") + 3, strLayerJSON2.lastIndexOf("[") - 2);
