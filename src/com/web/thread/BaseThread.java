...
public class BaseThread extends Thread {
	...
	public BaseThread(String taskType, int taskStatus, String taskName, Date starttime, Date finishtime, int iprogress,
			String markinfo) {
		pTaskinfo = new TaskInfo(taskType, taskStatus, taskName, starttime, finishtime, iprogress, markinfo);
		bStopThread = false;
	...
	/*
	 * public int getTaskId() { return pTaskinfo.getTaskId(); } public void
	 * setTaskId(int taskId) { pTaskinfo.setTaskId(taskId);; }
	 */
	...
	public boolean PrintTaskInfo(Connection conn) {
		...
		try {
			Object[] params = { getId(), getTaskName(), getTaskType(), getTaskStatus(), getTaskStartTime(),
					getTaskEndTime(), getTaskProgress(), getTaskMarkinfo() };
