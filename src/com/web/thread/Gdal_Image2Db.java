...
public class Gdal_Image2Db {
	...
	public static void Image2Db(String strImageUrl) {
		...
		// //右下角点坐标
		// dbX[2]=geoTransform[0] + xSize * geoTransform[1] + ySize *
		// geoTransform[2];
		// dbY[2]=geoTransform[3] + xSize * geoTransform[4] + ySize *
		// geoTransform[5];
		// //左下角坐标
		...
		// System.out.println(dbX[0]+" "+dbY[0]+", "+dbX[1]+" "+dbY[1]+",
		// "+dbX[2]+" "+dbY[2]+", "+dbX[3]+" "+dbY[3]);
		// System.out.println(a[0]+" "+a[1]+" "+b[0]+" "+b[1]+" "+c[0]+"
		// "+c[1]+" "+d[0]+" "+d[1]);
		hDataset.delete();
		...
		//
		// sql += "(FileName, FilePath, FileSize, satellite, acquisitionTime,
		// archiveTime, CellSizexy,"
		// + "Columns,Rows,
		// BandsNumber,RasterFormat,ExtentTop,ExtentLeft,ExtentBottom,ExtentRight,Shape)"
		// + " values(";
		...
		// //连接MySQL
		// ed.initParam("E:\\MyEclipse2014
		// workspace\\archives\\libs\\mysql.ini");
		// //插入数据库
		// ed.Insert(sql);
		// } catch (Exception e) {
		// e.printStackTrace();
