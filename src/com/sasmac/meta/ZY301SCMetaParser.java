...
public class ZY301SCMetaParser implements MetaParser {
	...
	public spatialmetadata ParseMeta(String strxmlFile) throws Exception {
		...
		ZY301SpatialMeta m_SpatialMeta = new ZY301SpatialMeta();
		org.dom4j.io.SAXReader reader = new org.dom4j.io.SAXReader();
		org.dom4j.Document doc = reader.read(xmlFile);

		org.dom4j.Node node = null;

		node = doc.selectSingleNode("//sensor_corrected_metadata/productComponents/file/Filename");
		if (node != null) {
		...
		node = doc.selectSingleNode("//sensor_corrected_metadata/productInfo//ProductID");
		if (node != null) {
			Integer iProductId = Integer.parseInt(node.getText());
			m_SpatialMeta.setProductId(iProductId);
		}
		node = doc.selectSingleNode("//sensor_corrected_metadata/productInfo/SatelliteID");
		if (node != null) {
			String satellite = node.getText();
			m_SpatialMeta.setSatellite(satellite);
		}
		node = doc.selectSingleNode("//sensor_corrected_metadata/productInfo/SensorID");
		if (node != null) {
			String sensor = node.getText();
			m_SpatialMeta.setSensor(sensor);
		}

		node = doc.selectSingleNode("//sensor_corrected_metadata/productInfo/AcquisitionTime");
		if (node != null) {
		...
		node = doc.selectSingleNode("//sensor_corrected_metadata/productInfo/CloudPercent");
		if (node != null) {
		...
		node = doc.selectSingleNode(
				"//sensor_corrected_metadata/productInfo/ProductGeographicRange/LeftTopPoint/Longtitude");
		if (node != null) {
		...
		node = doc.selectSingleNode(
				"//sensor_corrected_metadata/productInfo/ProductGeographicRange/LeftTopPoint/Latitude");
		if (node != null) {
		...
		node = doc.selectSingleNode(
				"//sensor_corrected_metadata/productInfo/ProductGeographicRange/RightTopPoint/Longtitude");
		if (node != null) {
			TopRightLong = node.getText();
			m_SpatialMeta.setTopRightLong(Double.parseDouble(TopRightLong));
		}
		node = doc.selectSingleNode(
				"//sensor_corrected_metadata/productInfo/ProductGeographicRange/RightTopPoint/Latitude");
		if (node != null) {
		...
		node = doc.selectSingleNode(
				"//sensor_corrected_metadata/productInfo/ProductGeographicRange/RightBottomPoint/Longtitude");
		if (node != null) {
			BottomRightLong = node.getText();
			m_SpatialMeta.setBottomRightLong(Double.parseDouble(BottomRightLong));
		}
		node = doc.selectSingleNode(
				"//sensor_corrected_metadata/productInfo/ProductGeographicRange/RightBottomPoint/Latitude");
		if (node != null) {
		...
		node = doc.selectSingleNode(
				"//sensor_corrected_metadata/productInfo/ProductGeographicRange/LeftBottomPoint/Longtitude");
		if (node != null) {
			BottomLeftlong = node.getText();
			m_SpatialMeta.setBottomLeftlong(Double.parseDouble(BottomLeftlong));
		}
		node = doc.selectSingleNode(
				"//sensor_corrected_metadata/productInfo/ProductGeographicRange/LeftBottomPoint/Latitude");
		if (node != null) {
