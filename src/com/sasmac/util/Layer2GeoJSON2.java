...
public class Layer2GeoJSON2 {
	 ...
	 */
	public String ToGeoJSON2(String LayerName2, String wkt2) throws ParseException {
		...
		try {
			conffilepath2 = Layer2GeoJSON2.class.getClassLoader().getResource("").toURI().getPath();
		...
		try {
			JDBCDataStore ds2 = (JDBCDataStore) factory2.createDataStore(params2);
			...
			String[] fields2 = { geometryAttributeName2, "dataid", "FileName", "FilePath", "FileSize", "CellSizexy",
					"Columns", "Rows", "BandsNumber", "DataType", "acquisitionTime", "archiveTime" };
