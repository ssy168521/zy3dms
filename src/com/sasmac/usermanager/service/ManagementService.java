...
public class ManagementService {
	...
	/**
	 * SUNJ 2017.2.11修改 修改成员 private ConnectionMyDB cndb;
	...
	public ManagementService() {
		...
		// this.cndb=new
		// ConnectionMyDB("jdbc:mysql://localhost:3306/test","root","111111");
		// this.cndb=new
		// ConnectionMyDB("jdbc:mysql://192.168.1.177:3306/USERMANAGER","root","123456");
		...
		/*
		 * System.out.println(this.conn); System.out.println(this.ServprivDao);
	...
	public void closeService() {
		/**
		 * SUNJ 2017.2.11修改 修改成员cndb.closeCONN();
