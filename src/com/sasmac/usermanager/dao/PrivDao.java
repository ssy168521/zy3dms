...
public class PrivDao {
	...
	/**
	 * SUNJ 2017.2.11修改 修改构造函数 PrivDao(ConnectionMyDB cndb)
	...
	public Roleinfo getRoleinfo(String roleid) {
		...
		/*
		 * UserinfoDto myUserdto=new UserinfoDto(); Userinfo myuser=new
		 * Userinfo();
		 */
		Roleinfo myrole = new Roleinfo();
		/*
		 * String sqlU =
		 * "select ID,USERNAME,REGTIME,VALID,ONLINE from TB_USER where ID=?";
