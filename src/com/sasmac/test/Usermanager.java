...
public class Usermanager {
	...
	public static void main(String[] args) {
		/*
		 * ManagementService manageServ=new ManagementService(); UserinfoDto
		 * myuseDto=manageServ.getRoleDao().getUserinfodto("8");
		 * 
		 * 
		 */
	...
	public static void showUserinfo(UserService userServ) {
		...
		if (prividlist != null) {
			for (int i = 0; i < prividlist.size(); i++) {
				System.out
						.println("权限ID:" + prividlist.get(i).getPrivid() + "---权限名:" + prividlist.get(i).getPrivname());
			}
		}
	}
